  ...
  public: {
    Tables: {
      ...
      fabrication_jobs: {
        ...
        Relationships: [
          {
            foreignKeyName: "fabrication_jobs_rfq_id_fkey"
            columns: ["rfq_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "fabrication_jobs_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      fabrication_quotes: {
        ...
        Relationships: [
          {
            foreignKeyName: "fabrication_quotes_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "fabrication_jobs"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "fabrication_quotes_rfq_id_fkey"
            columns: ["rfq_id"]
            isOneToOne: false
            referencedRelation: "rfqs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fabrication_quotes_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      fabrication_schedules: {
        ...
        Relationships: [
          {
            foreignKeyName: "fabrication_schedules_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "fabrication_jobs"
            referencedColumns: ["id"]
